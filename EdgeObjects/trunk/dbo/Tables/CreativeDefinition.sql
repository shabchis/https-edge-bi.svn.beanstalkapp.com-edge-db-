CREATE TABLE [dbo].[CreativeDefinition] (
    ...
    CONSTRAINT [PK_CreativeDefinition] PRIMARY KEY CLUSTERED ([GK] ASC),
    CONSTRAINT [FK_CreativeDefinition_Account] FOREIGN KEY ([AccountID]) REFERENCES [dbo].[Account] ([ID]),
    CONSTRAINT [FK_CreativeDefinition_Creative] FOREIGN KEY ([Creative_gk]) REFERENCES [dbo].[Creative] ([GK]),
    CONSTRAINT [FK_CreativeDefinition_EdgeType] FOREIGN KEY ([Parent_type]) REFERENCES [dbo].[MD_EdgeType] ([TypeID]),
    CONSTRAINT [FK_CreativeDefinition_EdgeType1] FOREIGN KEY ([Creative_type]) REFERENCES [dbo].[MD_EdgeType] ([TypeID])
);
